...
export const metadata = {
    ...
    alternates: {
      canonical: 'https://drpayalbajaj.com/ivf-fertility-doctor-in-delhi',
    },
    
    openGraph: {
      title: 'Best IVF Clinic in Delhi India With High IVF Success Rate',
      description: 'Consult with Dr Payal Bajaj, the best IVF specialist in Delhi for fertility care. Get affordable IVF treatment & personalised support. Book a free consult now.',
      url: 'https://drpayalbajaj.com/ivf-fertility-doctor-in-delhi/',
  ...
  import LandingPage from "@/ivf-fertility-doctor-in-delhi/Landingpage";
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "WebPage",
              "@id": "https://drpayalbajaj.com/ivf-fertility-doctor-in-delhi/#webpage",
              "url": "https://drpayalbajaj.com/ivf-fertility-doctor-in-delhi/",
              "name": "Best IVF Clinic in Delhi India",
              "description": "Consult with Dr Payal Bajaj, the best IVF specialist in Delhi, for fertility care. Get affordable IVF treatment & personalised support. Book a free consult now.",
              "inLanguage": "en-AU",
              ...
              "breadcrumb": {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    ...
                    "position": 2,
                    "name": "ivf-treatment",
                    "item": "https://drpayalbajaj.com/ivf-fertility-doctor-in-delhi/"
                  }
                ]
              }
            })
