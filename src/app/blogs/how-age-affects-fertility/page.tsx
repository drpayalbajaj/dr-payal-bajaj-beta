                ...
                <div className='relative w-full flex flex-col gap-8'>
                    ...
                    <div className='w-full relative flex flex-col gap-5'>
                        ...
                        <p className='font-medium text-steel-gray md:text-xl text-base leading-[1.2]'>
                            ...
                            <br />
                            <br />
                            This doesn't mean pregnancy is impossible after 35—but it may take longer, and <strong className='text-maroon-800'>there is a higher risk of complications or miscarriage</strong> due to poor egg quality.
                        </p>
                        <h2 className='font-bold md:text-2xl text-lg text-primary'>
                        ...
                        <p>
                            We often assess a woman&apos;s fertility by checking her <strong className='text-maroon-800'>AMH (Anti-Müllerian Hormone) levels, AFC (Antral Follicle Count)</strong>  via ultrasound, and <strong className='text-maroon-800'>FSH levels.</strong> These help us understand her ovarian reserve and guide her treatment options.
                        </p>
                        ...
                        <p className='font-medium text-steel-gray md:text-xl text-base leading-[1.2]'>
                            ...
                            <br />
                            <br />
                            At our center, we offer <strong className='text-maroon-800'>advanced fertility preservation services</strong> and help women understand their best window for egg freezing. It's not just about planning for today—it&apos;s about securing your choices for tomorrow.
                        </p>
