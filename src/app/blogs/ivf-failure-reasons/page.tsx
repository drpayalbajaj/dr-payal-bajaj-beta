                ...
                <div className='bg-new-light-500 max-w-[768px] w-full mx-auto mt-5 '>
                    <div className='relative w-full flex flex-col gap-8'>
                        ...
                        <div className='w-full relative flex flex-col gap-5'>
                            ...
                            <p className='font-medium text-steel-gray md:text-xl text-base leading-[1.2]'>
                                Even the best embryos need a healthy environment to implant. Sometimes, problems like <strong className='text-dark'>thin endometrium, fibroids, polyps, adhesions,</strong>  or <strong className='text-dark'>chronic endometritis</strong> go unnoticed and interfere with implantation. These issues are often missed unless specifically investigated.
                                <br />
                                <br />
                                At our center, we ensure a thorough <strong className='text-dark'>evaluation of the uterine lining</strong> before embryo transfer. We may advise <strong className='text-dark'>hysteroscopy, saline sonography, or endometrial receptivity testing (ERA)</strong> when required. Treating these conditions early ensures that the uterus is well-prepared for successful implantation.
                            </p>
                            ...
                            <p className='font-medium text-steel-gray md:text-xl text-base leading-[1.2]'>
                                As women age, the number and quality of eggs decrease. Women with <strong className='text-dark'>low AMH levels</strong> or those over the age of 35-40 often face this challenge. Poor egg quality leads to poor embryo formation, and thus a lower chance of success.
                                <br />
                                <br />
                                If you have low ovarian reserve, the IVF protocol must be carefully tailored. We use <strong className='text-dark'>mild stimulation, dual trigger, or adjuvants like DHEA and CoQ10</strong> to improve egg quality. In some cases, <strong className='text-dark'>IVF with donor eggs</strong> may be a recommended and highly successful option. <strong className='text-dark'>Each plan is customized based on age, hormone levels, and previous responses.</strong>
                            </p>
                            ...
                            <p className='font-medium text-steel-gray md:text-xl text-base leading-[1.2]'>
                                Sometimes everything seems perfect—the embryos are good, and the uterus is ready—yet pregnancy doesn&apos;t happen. This may be due to <strong className='text-dark'>implantation failure,</strong> which can occur due to <strong className='text-dark'>immune factors, blood clotting disorders, or timing mismatch</strong> between the embryo and the endometrium.
                                <br />
                                <br />
                            ...
                            <p className='font-medium text-steel-gray md:text-xl text-base leading-[1.2]'>
                                ...
                                <br />
                                <br />
                                <strong className='text-dark'>Take the first step—book your consultation today. Your dream of parenthood deserves a second chance.</strong>
                            </p>
                        </div>
                    </div>
                </div>
