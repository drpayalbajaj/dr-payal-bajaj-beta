...
export default function Hero() {
  return (
    <section className="w-full relative overflow-hidden">
      ...
      <div
        className="absolute inset-0 min-[924px]:bg-[url(/image/banner/banner.jpg)] bg-none opacity-10"
        style={{
        ...
        <div className="w-full grid lg:grid-cols-2 grid-cols-1 gap-16 items-center ">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
              Expert IVF care with cutting-edge technology and compassionate
              support. Let us help you turn hope into happiness with
      ...
      case "instagram":
        return (
           <svg
            ...
            aria-hidden="true"
          >
            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.33 3.608 1.304.975.975 1.243 2.242 1.304 3.608.058 1.266.07 1.645.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.33 2.633-1.304 3.608-.975.975-2.242 1.243-3.608 1.304-1.266.058-1.645.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.33-3.608-1.304-.975-.975-1.243-2.242-1.304-3.608C2.175 15.747 2.163 15.368 2.163 12s.012-3.584.07-4.85c.062-1.366.33-2.633 1.304-3.608.975-.975 2.242-1.243 3.608-1.304C8.416 2.175 8.796 2.163 12 2.163zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zm0 10.162a3.999 3.999 0 1 1 0-7.998 3.999 3.999 0 0 1 0 7.998zm6.406-11.845a1.44 1.44 0 1 1-2.881 0 1.44 1.44 0 0 1 2.881 0z" />
          </svg>
        );
      case "facebook":
        return (
