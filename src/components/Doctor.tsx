            ...
            >
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 relative overflow-hidden">
                ...
                <p className="text-lg text-gray-600 leading-relaxed relative">
                  Dr Payal Bajaj is an experienced obstetrician and gynecologist
                  with over 20 years of experience in the discipline. She is
                  also a Reproductive endocrinologist and Infertility specialist
                  par excellence.
                </p>
              </div>
              ...
              >
                ...
                <div className="relative">
                  <h3 className="text-2xl font-bold mb-4 leading-tight">
                    Creating Miracles with Personalized IVF Solutions for
                    Growing Families
                  </h3>
                  <p className="text-lg leading-relaxed opacity-90">
                    Dr. Payal Bajaj, one of the best and most highly reputable
                    gynaecologists, is an IVF specialist in Delhi. She helps
                    provide detailed explanations and solutions for any
                    condition concerning the female reproductive system.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                  ...
                  {/* CHANGED HERE: Made text bigger, darker, and slightly bolder */}
                  <p className="text-md text-gray-700 font-medium">
                    Academic Excellence Throughout Career
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="mt-4">
                  <p className="text-lg text-gray-900 font-medium leading-relaxed w-full md:text-justify">
                    Dr Payal Bajaj has won various academic awards throughout
                    her career. She is expert at stimulating and following up
                    ovarian cycles in different types of infertile patients and
                    is a strong believer in individualized management of
                    infertility. She sticks to evidence-based protocols and
                    strives to provide competent, rational, ethical, and
                    transparent clinical care to infertile couples.
                  </p>
                </div>
              </motion.div>
            </motion.div>
